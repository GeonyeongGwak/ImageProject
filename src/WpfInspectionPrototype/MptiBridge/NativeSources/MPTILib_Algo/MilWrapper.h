...
#define M_SOURCE_BUFFER_FORMAT                        6935L
...
#define M_GC_TOTAL_FRAME_MISSED                       6983L
...
#define M_TYPE_STRING								  MAKE_INT64(0x0000007000000000)
// MIL9 버전과 MIL10버전이 M_TYPE_STRING Define된 값이 다름.. 
...
#define M_SEQ_ENCAPSULATION         3L    // unsupported but probably useful
...
// 31 system types reserved MSEQSYTEMES(1 - 31)

#define MSEQSYSTEMSCATEGORY(x)      (x<<9)
#define M_SEQ_HARDWARE              MSEQSYSTEMSCATEGORY(0L)
#define M_SEQ_SOFTWARE              MSEQSYSTEMSCATEGORY(1L)
...
#define M_SEQ_CONTAINER_SOURCE         (0L << 16)
...
/************************************************************************/
/* MseqInquire() / MseqGetContext()                                     */
/************************************************************************/
#define M_TYPE                                        1008L
#define M_FILE_FORMAT                                 1015L
#define M_STREAM_FILE_NAME                            3904L // already defined elsewhere
...
#define M_RESULT_OUTPUT_UNITS   1300L // Also in milim.h                    5L
...
#define M_SOFTWARE_MIL10                              0x010000L
#define M_SOFTWARE                                    20L
#define M_HARDWARE                                    21L
#define M_HARDWARE_MIL10                              0x020000L
#define M_MIXED                                       22L
...
extern HINSTANCE g_hMilDLL;
extern HINSTANCE g_hMilblobDLL;
extern HINSTANCE g_hMilimDLL;
extern HINSTANCE g_hMilpatDLL;
extern HINSTANCE g_hMilcodeDLL;
extern HINSTANCE g_hMilstrDLL;
extern HINSTANCE g_hMilcalDLL;
extern BOOL g_bMil10;
