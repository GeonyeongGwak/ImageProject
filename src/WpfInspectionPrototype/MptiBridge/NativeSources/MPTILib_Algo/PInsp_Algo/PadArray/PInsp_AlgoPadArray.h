...
class IPINSP_ALGO;
class CPInsp_AlgoPadArray : public IPINSP_ALGO
{
private:

public:
	CPInsp_AlgoPadArray(void);
	virtual ~CPInsp_AlgoPadArray(void);
	...
	virtual BOOL TeachAlgorithm_Dll(const InspAlgo& InspAlgo, std::vector<PIAL::_AlignResult> vecAlignResult, PIAL::Insp_Image* pImg_buf, InspAlgoParam algoParam, void* sRstAlgo, PIAL::PInspDataSet* InspDataSet, PIAL::_TotalInspExceptArea PIALTieArea, PIAL::BodyInfo* bodyInfo, PIAL::PI_Buff* Mask_buf);
};