...
class IPINSP_ALGO;
class CPInsp_AlgoLeadSideSolder : public IPINSP_ALGO
{
private:

public:
	CPInsp_AlgoLeadSideSolder(void);
	virtual ~CPInsp_AlgoLeadSideSolder(void);
	...
	BOOL InspSideSolder(const InspAlgo &sInspAlgo, WndAlgoImg &sWndAlgoImg, InspRoiImgBuf &sInspImgBuf, UCHAR* ucArrDstImg, RstAlgoLeadSideSolder * sRstAlgo, int nLeadTipPos, UCHAR* ucArrDstImgAC);
