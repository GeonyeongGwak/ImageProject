...
class IPINSP_ALGO;
class CPInsp_AlgoWidth : public IPINSP_ALGO
{
private:

public:
	CPInsp_AlgoWidth(void);
	virtual ~CPInsp_AlgoWidth(void);
	...
	BOOL InspWidth(const InspAlgo &sInspAlgo, WndAlgoImg &sWndAlgoImg, RstAlgoLength *sRstAlgo, int nLeadTipPos = -1, UCHAR* ucArrDstImg = NULL);
