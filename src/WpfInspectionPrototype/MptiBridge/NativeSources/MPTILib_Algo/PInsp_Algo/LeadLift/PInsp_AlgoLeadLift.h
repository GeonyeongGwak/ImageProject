...
class IPINSP_ALGO;
class CPInsp_AlgoLeadLift : public IPINSP_ALGO
{
private:

public:
	CPInsp_AlgoLeadLift(void);
	virtual ~CPInsp_AlgoLeadLift(void);
	...
	BOOL InspLift(const InspAlgo &sInspAlgo, WndAlgoImg &sWndAlgoImg, RstAlgoLeadLift * sRstAlgo = NULL, int nLeadTipPos = -1, InspAlgoTempResult *sInspAlgoTempResult = NULL);
