...
class IPINSP_ALGO;
class CPInsp_AlgoTilt : public IPINSP_ALGO
{
private:

public:
	CPInsp_AlgoTilt(void);
	virtual ~CPInsp_AlgoTilt(void);
	...
	BOOL InspTilt(const InspAlgo &sInspAlgo, WndAlgoImg &sWndAlgoImg, RstAlgoTilt *sRstAlgo, AlignResult * sAlignRes = NULL, int nAlignResCnt = 0);
