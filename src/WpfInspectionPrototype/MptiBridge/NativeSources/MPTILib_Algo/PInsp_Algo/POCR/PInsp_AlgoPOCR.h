...
class IPINSP_ALGO;
class CPInsp_AlgoPOCR : public IPINSP_ALGO
{
private:

public:
	CPInsp_AlgoPOCR(void);
	virtual ~CPInsp_AlgoPOCR(void);
	...
	void SetRstROI(const InspAlgo &sInspAlgo, WndAlgoImg &sWndAlgoImg, InspAlgoParam stAlgoParam, RstAlgoPOCR * rstPOCR);
	void GetMeanStdDev(std::vector<double>vInput, double* dMean, double* dStdDev);
};
