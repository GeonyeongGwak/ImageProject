...
public static class ReferenceInspectionPacketBuilder
{
    ...
    private static IReadOnlyList<string> GetImportantPrefixes(string referenceName)
    {
        return referenceName switch
        {
            ...
            "Width" => ["InvChk", "Use2D", "Use3D", "R2D", "R3D", "Range", "MnMx2D", "MnMx3D", "MnMxAvg3D", "StdWidth", "StdW", "StdLength", "StdLen", "UseWidth", "UseLength", "MnMxWidth", "MnMxLength", "PerOK", "ROI"],
            "Volume" => ["CSIPC", "ClassIPC", "StdBodyHei", "StdBodyHeight", "StdW", "StdWidth", "StdLen", "StdLength", "Use2D", "R2D", "MnMx2D", "Use3D", "R3D", "MnMxAvg3D", "ChipTrack", "PerOK", "UseBW", "UseStdMax", "LimitUp", "TPSelBlob", "StdVolume", "ARefV", "UseHei", "HeightPer", "MnMxHei", "StdArea", "UseArea", "MnMxArea", "Use_CJ", "Area_CJ", "AreaP_CJ", "UseInc", "Inc", "IncMin", "IncMax", "IncROI", "RH", "BH", "RHROI", "FH", "FHS", "UseFlt", "FltStepNar", "ChipTrackGap", "ArrN", "ArrF"],
            ...
            "Fillet" => ["UseFilletInsp", "UARH", "ChipTrack", "Gap", "Interval", "DivCnt", "TipDir", "HgtOptVal", "AngOptVal", "ARHEnb", "HOpt", "AOpt", "MnA", "MxA", "MnAS", "MxAS", "UDir", "ULTP", "LTP"],
            "Foot" => ["UOpt", "ROIF", "ArBin", "Pnt", "OptVal", "SrchF", "SpcR", "WndOffsetF", "FOpt", "FOpt2", "UPatAgl", "U2Foot", "UPadAutoT", "FType", "FDir", "TchFDir", "URmvPA", "U2DImgFIW", "RmvWireH", "CrkH", "WSOffset", "LSOffset", "HSOffset", "FSbMn", "FSbMx", "FSPDIA", "PadX", "PadY", "PEMR", "UST", "FdOptOdr", "FdOptOdr2", "UTchPRe", "PadW", "PadH", "Rdi", "SetData", "SetData2", "LV", "LtData", "Mop"],
            "SolderCone" => ["TCHei", "TeachHeight", "HeightLv", "Hei", "UseSolderHighest", "UHstVD", "UIVD", "UIVML", "UIVP", "HestH", "GapH", "LvlCnt", "PieHD", "DifOpt", "DifEnb"],
            "Grid" => ["Col", "Column", "Row", "IgnClr", "IgnoreColor", "StdDev", "DetW", "DetectWidth", "DetLen", "DetectLength", "UseIgn", "IgnoreUse", "UseStd", "StdUse", "Use3D", "R3D", "MnMxAvg3D", "Clr", "Color", "EA", "UseImageMix", "ImageMixCount"],
            "Line" => ["Inv", "Invert", "UseFlt", "FilterIsUse", "FltStepNar", "FilterStepNarrow", "UseSft", "ShiftIsUse", "Sft", "UseArea", "MnMxArea", "AreaCur", "TPSelBlob", "Use2D", "MnMx2D", "TPR2D", "Use3D", "MnMxAvgHei", "TPR3D", "TechC", "UseIPC", "CSIPC", "TPStdIPC", "TCWUse", "TCW", "MnMxTCWR", "TCLenUse", "TCLen", "MnMxTCLen", "UseSftX", "UseSftY", "IsHorizon", "MeasureDir", "UseAng", "TCRot", "Cross", "C_Fix", "C_Opt", "FH", "LFO", "EP", "Data", "UseROI", "ROI"],
            "Edge" => ["Inv", "UseFlt", "FltStepNar", "UseSft", "Sft", "UseArea", "MnMxArea", "AreaCur", "TPSelBlob", "Use2D", "MnMx2D", "TPR2D", "Use3D", "MnMxAvgHeiR", "TPR3D", "TechC", "UseIPC", "CSIPC", "TPStdIPC", "TCWUse", "TCW", "MnMxTCWR", "TCLenUse", "TCLen", "MnMxTCLen", "UseSftX", "UseSftY", "SetLineCnt", "Grp", "UseAng", "TCRot", "SetInspCond", "ArrSetInspCondition", "ArrIsHorizon", "ArrMeasureDirection", "ArrTeachLength", "ArrSetTeachCenter", "SetLine", "LineFindType", "LineFindRate", "DisX", "DisXMnMx", "DisY", "DisYMnMx", "FC", "FH", "CC", "InspOption"],
            "Barcode" => ["Bar_N", "Bar_S", "Bar_A"],
            "PatternDiff" => ["LayerCnt", "ModelAddCnt", "UsePattern", "ModelPath", "LayerType_", "PolyAreaCnt_", "PolyPtrCnt_", "PolyDir_", "PolyPtrX_", "PolyPtrY_", "BWData_", "TeachLength", "TeachWidth", "TeachArea", "Theta", "UseDarkForeign", "Filter", "MatchingArea", "NGBlobMode", "HistoData", "ArrModelName", "SizeAnd", "UseExcPattern", "ExcModelAddCnt", "ExcPatternScore", "ArrExcModelName", "LightData", "MergeLayer", "EdgeFilter", "FilterSize", "EdgeFilterLevel", "ArrAlignArea", "UseArrAlignArea", "AlignAcceptScore", "bMth", "UseMaskBW", "BWData_Mask", "UseF_Mask", "FS_Mask"],
            "PadArray" => ["NData", "FData", "UseData", "ROIF", "ROIS"],
